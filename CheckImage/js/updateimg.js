	...
	window.onload = function() {
				...
				if(typeof FileReader === 'undefined') {
					alert("Sorry, your browser doesn't support the FileReader");
				...
				function readFile() {
					...
					if (iLen>9) {
							alert("Please select less than nine images.");
							return;
						}
					...
					for(var i = 0; i < iLen; i++) {
						if(!input['value'].match(/.jpg|.png|.jpeg/i)) {　　 //判断上传文件格式
							return alert("The format of the uploaded image is incorrect, please upload again.");
						}
						if(this.files[i].size>10*1024*1024){
							alert("Each images cannot be larger than 10M.");
							return;
						}
