...
# xadmin.site.unregister(Reversion)
...
class MemberAdmin(object):
    list_display = ("id", "email", "password", "create_time")
    list_display_links = ("email",)
    # wizard_form_list = [
    #     ("First's Form", ("email", "password"))
    # ]
    search_fields = ["email"]
    list_filter = [
        "email"
    ]
    list_quick_filter = [{"field": "email", "limit": 10}]
...
class HistoryAdmin(object):
    list_display = ("id","mid", "name", "srcFilePath", "destFilePath", "thumnail", "result", "category", "create_time")
    list_display_links = ("mid", "name", "result", "category")
    # wizard_form_list = [
    #     ("First's Form", ("mid", "name"))
    # ]
    search_fields = ["mid", "category"]
    list_filter = [
        "mid"
    ]
    list_quick_filter = [{"field": "mid", "limit": 10}]
...
@xadmin.sites.register(Collect)
class CollectAdmin(object):
    list_display = ("id","hid",  "mid", "name", "srcFilePath", "destFilePath", "thumnail", "result", "category", "create_time")
    list_display_links = ("hid","mid", "name", "result", "category")
    # wizard_form_list = [
    #     ("First's Form", ("mid", "name"))
    # ]
    search_fields = ["hid","mid", "category"]
    list_filter = [
        "mid"
    ]
    list_quick_filter = [{"field": "mid", "limit": 10}]
